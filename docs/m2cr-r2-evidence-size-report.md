...
Fixed-artifact total: **8,820,592 bytes** (measured; regenerated after the external audit
...
| Fixed freeze artifacts | 8,820,592 | measured (sum above) |
| Complete bundle, evidence classes with measured bases | 26,565,934 | derived: fixed total + both per-node products |
