...
| 20 | Full executable suite (plan §8) | — | `python -m pytest -q`; baseline 442 passed, 1 skipped recorded pre-edit; final integrated tree 711 passed, 2 skipped (both remaining skips are the opt-in real-root walk and the pre-existing baseline skip) |
