...
| 20 | Full executable suite (plan §8) | — | `python -m pytest -q`; baseline 442 passed, 1 skipped recorded pre-edit; integrated tree 711 passed, 2 skipped; after the external-audit-round-3 remediation (F1–F6 + checkpoint CP-1..CP-5, head eeefeef) 723 passed, 2 skipped (both remaining skips are the opt-in real-root walk and the pre-existing baseline skip) |
