...
## D56/D56a/D56b — A7 protocol frozen; attempt 1 FAILED pre-cell (job 11485635, submission SPENT); diagnostic attributed the PS1 failure; D56b implemented + exact-head-reviewed (author-accepted residual, Update 8), Draft PR open, STOP at Draft (2026-07-21/22) — anchors M56 66ca91cd / M56a e9457d71 / M56b = future D56b merge; code anchor B e4894e2e
...
- **NEXT (each a separate author act):** (1) author Ready + merge of the D56b Draft PR producing M56b (true merge, second parent = PR head), then `origin/main == M56b`; (2) fresh byte-exact launch authorization naming M56b; (3) author-executed attempt 2 (P0–P7 against `_02`); on success: evidence commit allowlist B (the §8 file list) + v1.22. A7 remains OWED.
