...
## D56/D56a/D56b — A7 protocol frozen; attempt 1 FAILED pre-cell (job 11485635, submission SPENT); diagnostic attributed the PS1 failure; D56b correction implemented, review gate + Draft PR in flight (2026-07-21/22) — anchors M56 66ca91cd / M56a e9457d71 / M56b = future D56b merge
...
- **NEXT (each a separate author act):** (1) two-model read-only review gate on D56b this session (fresh Codex gpt-5.6-sol xHigh + fresh Opus 4.8; at most one bounded correction pass), then Draft PR — STOP at Draft; (2) author Ready + merge producing M56b, then `origin/main == M56b`; (3) fresh byte-exact launch authorization naming M56b; (4) author-executed attempt 2 (P0–P7 against `_02`); on success: evidence commit allowlist B + v1.22. A7 remains OWED.
