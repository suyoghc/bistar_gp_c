...
**Status.** D56 merged (PR #24, M56 `66ca91cd8a5e0a2bbb7d984b2e5298707160d6c0`); D56a merged (PR #25, launch anchor M56a `e9457d719bfbaea9e890329687b8c166b872570a`). The launch authorization was cast 2026-07-21 and is SPENT on failed attempt job 11485635 (Update 5); the four-file failure evidence is committed at `runs/d19_a7_failed_11485635/` on branch `evidence/d19-a7-failed-attempt-11485635` (Draft PR; STOP before Ready/merge). **HARD STOP before: the read-only Della diagnostic (separate authorization) / any script, protocol, validator, or test change (D56b: new review cycle + new launch anchor required) / any resubmission / v1.22 / poster branch / M2d / science.** A7 remains OWED. D45 remains permanently UNVALIDATED_ATTEMPT; v1.18 remains absent; D53 PRESERVE_STOP is unaltered. Deletion of the two superseded pre-D22 anchors remains an OPEN separate author decision.
