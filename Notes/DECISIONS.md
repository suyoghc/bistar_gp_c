...
**Status.** Draft PR pending. **HARD STOP before Ready / merge / launch authorization / Della write / benchmark / evidence commit / v1.22 / M2d / science.** D45 remains permanently UNVALIDATED_ATTEMPT; v1.18 remains absent; D53 PRESERVE_STOP is unaltered. Deletion of the two superseded pre-D22 anchors remains an OPEN separate author decision.
